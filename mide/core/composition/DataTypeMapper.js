goog.provide('mide.core.DataTypeMapper');
 ...
 * 
 * @extends mide.core.DataTypeMapper
 * @constructor
 */
mide.core.DataTypeMapper = function(config) {
	this.config = config || {};
	if(!this.config.strategy) {
		this.config.strategy = mide.core.DataTypeMapper.SIMPLE_DATA_TYPE_COMPARISON;
	}
 ...
 * @private
 */
mide.core.DataTypeMapper.prototype.mappings = null;
 ...
 * @private
 */
mide.core.DataTypeMapper.prototype.getHash_ = function(source, event, target, operation) {
 ...
 * @public
 */
mide.core.DataTypeMapper.prototype.createMapping = function(source, event, target, operation) {
 ...
 * @public
 */
mide.core.DataTypeMapper.prototype.removeMapping = function(source, event, target, operation) {
	var hash = this.getHash_(source, event, target, operation);
 ...
 * @public
 */
mide.core.DataTypeMapper.prototype.map = function(source, event, target, operation, data) {
 ...
 * @public
 */
mide.core.DataTypeMapper.SIMPLE_DATA_TYPE_COMPARISON = function(source, event, target, operation) {
